...
setup(
    ...
    version=get_version("src/dkplastics/_version.py"),
    description="DKPlastics Website",
    long_description=readme(),
    long_description_content_type="text/markdown",
    # Landing page for DKPlastics
    url="",
    ...
    # Author details
    author="craig duhn",
    author_email="cduhn@hotmail.com",
    ...
    # Conveniently allows one to run the CLI tool
    entry_points={
        "console_scripts": [
